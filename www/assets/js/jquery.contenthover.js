...
(function($){  
	var methods = {
		init : function(options) {
			var defaults = {  
				data_selector: '.div-overlay',	// The selector for the element that will be the content of the overlay element to show on hover 
